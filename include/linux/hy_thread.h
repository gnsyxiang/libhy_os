 ...
 * 
 *     last modified: 24/01 2024 14:48
 */
#ifndef __LIBHY_OS_INCLUDE_HY_THREAD_H_
#define __LIBHY_OS_INCLUDE_HY_THREAD_H_
 ...
 * @brief 线程私有数据创建函数回调
 */
typedef void *(*HyThreadKeyCreateCb_t)(void);
 ...
 * @param key 私有数据
 */
typedef void (*HyThreadKeyDestroyCb_t)(void *key);

/**
 * @brief 设置线程私有数据
 *
 * @param handle 句柄
 * @param key_create 私有数据创建函数
 * @destroy_cb 私有数据销毁函数
 *
 * @return 成功返回0，失败返回-1
 *
