 ...
 * 
 *     last modified: 20/02 2024 10:31
 */
 ...
 * @param ip 存放ip地址的数组，长度为HY_SOCKET_IP_LEN_MAX
 * @param len 数组的长度
 *
 * @return 成功返回0，失败返回-1
 *
 * @note 数组长度不能太短，需要考虑IPV6的情况
 */
hy_s32_t HySocketGetIP(hy_s32_t socket, char *ip, hy_u32_t len);
