 ...
 * 
 * @file    hy_net_phy_demo.c
 * @brief   
 * @author  gnsyxiang <gnsyxiang@163.com>
 * @date    30/01 2024 19:06
 * @version v0.0.1
 * 
 * @since    note
 * @note     note
 ...
 * 
 *     last modified: 30/01 2024 19:06
 */
#include <stdio.h>
#include <unistd.h>
...
int main(int argc, char *argv[])
{
    ...
    do {
        ...
        HyNetPhyNetlinkStatus_e netlink_status;
        netlink_status = HyNetPhyNetlinkStatusGet("eth0");
        LOGI("netlink_status: %d \n", netlink_status);

        netlink_status = HyNetPhyNetlinkStatusGet("eth1");
        LOGI("netlink_status: %d \n", netlink_status);
